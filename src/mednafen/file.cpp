...
//#include <mednafen/compress/ZIPReader.h> EMSCRIPTEN
#include <mednafen/MemoryStream.h>
//#include <mednafen/IPSPatcher.h> EMSCRIPTEN
...
void MDFNFILE::ApplyIPS(Stream *ips)
{
...

 {
  ...
  count = 0; // IPSPatcher::Apply(ips, str.get()); EMSCRIPTEN
...
void MDFN_mkdir_T(const char* path)
{
 ...
 if(invalid_utf8)
 {
  errno = EINVAL;
   ...
   _wmkdir((const wchar_t*)u16path.c_str());
