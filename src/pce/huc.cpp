 ...
 */
 ...
 // XXXX FIXME file stuff should not be needed for HES playback
#include "pce.h"
#include "huc.h"
#include "pcecd.h"
...
//#include <mednafen/mempatcher.h> EMSCRIPTEN
...
//ArcadeCard *arcade_card = NULL; EMSCRIPTEN
...
{
 return 0; // (arcade_card->PhysRead(A, PCE_InDebug)); EMSCRIPTEN
}

static DECLFW(AC_PhysWrite)
{
 return; //(arcade_card->PhysWrite(A, V)); EMSCRIPTEN
}
...
//   MDFNMP_AddRAM(8 * 8192, 0x80 * 8192, CDRAM);	EMSCRIPTEN mempatcher
 ...
 //   MDFNMP_AddRAM(24 * 8192, 0x68 * 8192, SysCardRAM); EMSCRIPTEN mempatcher
   }
/* EMSCRIPTEN
 ...
 //  MDFNMP_AddRAM(2048, 0xF7 * 8192, SaveRAM); EMSCRIPTEN mempatcher
  }
 }
 catch(...)
 {
